...
class VKLoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        webViwe.translatesAutoresizingMaskIntoConstraints = false
...
extension VKLoginViewController: WKNavigationDelegate {
    func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
        ...
        if token != nil {
            ...
            let loginViweController = storyBoard.instantiateViewController(withIdentifier: "LoginFormController") as! LoginFormController
            loginViweController.modalPresentationStyle = .fullScreen
            self.present(loginViweController, animated: true, completion: nil)
