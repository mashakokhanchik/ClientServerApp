...
//    }
    ...
    private func sortedHeader() {
        let sectionsData = Dictionary(grouping: self.filterFriends, by: { String ($0.surname.prefix(1)) })
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.friendName.text = self.sections[indexPath.section].friend[indexPath.row].surname + " " + self.sections[indexPath.section].friend[indexPath.row].name
        cell.avatarImageView.image = UIImage(named: self.sections[indexPath.section].friend[indexPath.row].avatarImageView)
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchText.count == 0 {
            ...
            for friend in friends where friend.surname.lowercased().contains(searchText.lowercased()) || friend.name.lowercased().contains(searchText.lowercased()) {
