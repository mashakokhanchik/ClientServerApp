...
class PresenterPhoto: UIViewController {
    ...
    func setImage(){
        ...
        leftImageView.image = photos[indexPhotoLeft]//UIImage(named: photos[indexPhotoLeft])
        middleImageView.image = photos[indexPhotoMid]//UIImage(named: photos[indexPhotoMid])
        rightImageView.image = photos[indexPhotoRight]//UIImage(named: photos[indexPhotoRight])
